...
const IntroDescription = () => {
  ...
  return (
    <div>
      <div className="pb-48 px-[20vw] mx-auto">
        <div id="aboutme" className="flex items-start pb-12">
        ...
        <div className="flex items-center justify-center">
          ...
          <div id="phrase1" className="pl-12 flex justify-center items-center">
            <h1 className="text-2xl text-white font-light">
              ...
              One tech influencer in Myanmar, showcasing a variety of tech
              gadgets and updates in the captivating world of innovation.
            </h1>
          </div>
        </div>
      </div>
